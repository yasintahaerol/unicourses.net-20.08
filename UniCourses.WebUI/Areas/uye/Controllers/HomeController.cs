...
namespace UniCourses.WebUI.Areas.uye.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            foreach (var item in courseMembers)
            {
                boughtCourses.Add(item.Course);
            };
            List<Course> allCourses = rCourse.GetAll().ToList();
            foreach (var item in allCourses)
            {
                
            };
            List<Course> forShowCourse = allCourses.Except(boughtCourses).ToList();
            CourseCategoryVM courseCategoryVM = new CourseCategoryVM()
            {
                courseMember = courseMembers,
                Courses = forShowCourse
            };
